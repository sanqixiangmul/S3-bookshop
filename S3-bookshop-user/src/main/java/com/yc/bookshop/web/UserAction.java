...
import com.yc.bookshop.bean.UserExample;
import com.yc.bookshop.dao.UserMapper;
...
public class UserAction {
	...
	public Result login(@RequestBody User user) {
		...
		cue.createCriteria().andUNameEqualTo(user.getuName()).andUPwdEqualTo(user.getuPwd());
		List<User> list = uMapper.selectByExample(cue);
		if (list.isEmpty()) {
